...
export class DriverService {
    ...
    async create(createDriverDto: CreateDriverDto, files: DriverUploadFilesPostDto) {
    ...
    private async uploadDriverFiles(driverId: number, files: DriverUploadFilesPostDto) {
        const [adharCardResult, panCardResult, driverLicenseResult] = await Promise.all([
            this.uploadFileAsync(files.adhar_card[0], `driver/${driverId}/documents/adhar`),
            this.uploadFileAsync(files.pan_card[0], `driver/${driverId}/documents/pan`),
            this.uploadFileAsync(files.driver_license[0], `driver/${driverId}/documents/license`),
        ]);
